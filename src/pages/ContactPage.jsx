...
import { FaGithub, FaLinkedin, FaTwitter, FaEnvelope, FaPhone, FaMapMarkerAlt, FaLightbulb, FaDollarSign, FaClock, FaRocket } from "react-icons/fa";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFocused({ name: false, email: false, company: false, phone: false, subject: false, message: false });
  ...
  return (
    <>
      <SEO
        ...
        canonical="/contact"
        keywords={['Contact Chandrakant Nagpure', 'Hire Frontend Developer', 'React Developer Contact', 'WordPress Expert Hire', 'Web Development Services']}
      />
      <div
              ...
              <>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {/* Current Question */}
                    <div className="mb-8">
                      <h4 className="text-xl font-semibold mb-6 flex items-center gap-3" style={{ color: "#000" }}>
                        {React.createElement(interactiveQuestions[currentStep].icon, { size: 24, color: primaryColor })}
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <div className="font-medium" style={{ color: "#000" }}>{option.label}</div>
                                  {option.description && (
                    ...
                    <div className="flex justify-between">
                      ...
                      <motion.button
                        ...
                        style={{ background: canProceed() ? `linear-gradient(135deg, ${primaryColor}, ${secondaryColor})` : '#9CA3AF' }}
              ...
              <>
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    >
                      {t('contact.form.subject')} {Object.keys(interactiveAnswers).length === 0 ? t('contact.form.required') : '(Optional)'}
                    </label>
                    <input
                      type="text"
                      id="subject"
                      ...
                      placeholder={Object.keys(interactiveAnswers).length > 0 ? "Optional subject..." : t('contact.form.placeholders.subject')}
                      className={`w-full px-4 py-3 rounded-lg bg-white border ${
                        errors.subject
                          ? "border-red-500"
                          : "border-gray-200 focus:border-blue-500"
                  ...
                  <div className="relative">
                    ...
                    >
                      {Object.keys(interactiveAnswers).length > 0 ? 'Additional Message (Optional)' : `${t('contact.form.message')} ${t('contact.form.required')}`}
                    </label>
                    <textarea
                      id="message"
                      name="message"
