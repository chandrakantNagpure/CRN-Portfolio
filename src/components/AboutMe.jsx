...
function AboutMe() {
  ...
  const structuredData = {
    ...
    description:
      'Specializing in React, Next.js, WordPress, UI/UX design, and modern web technologies with over 5 years of experience.',
              ...
              <div className="grid grid-cols-2 gap-4">
                {skills.map((skill, index) => (
                  ...
                  >
                    ...
                    <span className="mt-1 text-base text-center" style={{ color: '#000' }}>
                      {skill.name}
                    </span>
                  </motion.div>
                ))}
