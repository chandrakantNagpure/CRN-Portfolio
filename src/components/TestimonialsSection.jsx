  ...
  const testimonials = [
    {
      ...
      avatar:
        'https://images.unsplash.com/photo-1494790108755-2616b2e5e008?w=64&h=64&fit=crop&crop=face',
      metrics: {
      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ color: currentTechColor }}
                >
                  {stat.number}
                </div>
                <div
                  className="text-sm md:text-base font-medium"
                  style={{ color: isDarkBg ? '#cbd5e1' : '#64748b' }}
                >
                  {stat.label}
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-6">
                <div
                  ...
                  style={{
                    backgroundColor: `${platformColors[currentTestimonialData.platform]}20`,
                  }}
                >
                  <PlatformIcon size={20} color={platformColors[currentTestimonialData.platform]} />
                </div>
                <span
        ...
        >
          ...
          <p
            ...
            style={{ color: isDarkBg ? '#e2e8f0' : '#64748b' }}
          >
            Let's work together to bring your project to life and achieve results that exceed your
            expectations.
          </p>
