    ...
    return (
      ...
      >
        ...
        <p className="text-gray-600 mb-6">
          I've received your project details and will get back to you within 2 hours 
        ...
        <button
          onClick={() => {
            ...
            setFormData({
              ...
              description: "", urgency: "normal", source: "website"
            });
          }}
            ...
            {formData.projectType && formData.timeline && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                ...
                <div className="text-sm text-green-600 mt-1">
                  *This is a rough estimate. Final price will be determined after detailed consultation.
                </div>
              </div>
            )}
