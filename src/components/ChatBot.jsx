...
const chatFlow = {
  welcome: {
    message: "👋 Hi there! I'm Chandrakant's AI assistant. I'm here to help you explore my services and potentially work together. What brings you here today?",
    options: [
  ...
  business_details: {
    message: "Perfect! Business websites are my specialty. What's most important for your business site?",
    options: [
  ...
  ecommerce_details: {
    message: "E-commerce is exciting! I've built several successful online stores. What will you be selling?",
    options: [
  ...
  redesign_details: {
    message: "Smart move! A fresh design can work wonders. What's the main issue with your current site?",
    options: [
  ...
  exploration: {
    message: "Welcome! I'd love to show you what I can do. I specialize in React, WordPress, and modern web development. What interests you most?",
    options: [
  ...
  tech_preferences: {
    message: "Excellent! I can create a stunning professional site that drives results. I'd love to discuss this further with you. May I get your contact details?",
    collectLead: true,
    leadContext: "business_professional"
  },

  lead_focus: {
    message: "Lead generation is my forte! I've helped businesses increase their leads by 200%+ with optimized websites. Let's chat about your specific goals!",
    collectLead: true,
    leadContext: "business_leads"
  },

  seo_focus: {
    message: "SEO is crucial! I build SEO-optimized sites that rank well and attract organic traffic. I'd be happy to discuss your SEO strategy!",
    collectLead: true,
    leadContext: "business_seo"
  },

  comprehensive: {
    message: "Perfect! A comprehensive approach is exactly what successful businesses need. I'd love to create a proposal tailored to your needs!",
    collectLead: true,
    leadContext: "business_comprehensive"
  },

  physical_products: {
    message: "Great! I've built e-commerce sites that handle inventory, shipping, and payments seamlessly. Let's discuss your product catalog and requirements!",
    collectLead: true,
    leadContext: "ecommerce_physical"
  },

  digital_products: {
    message: "Digital products are fantastic for scaling! I can build you a platform for secure downloads, licensing, and customer management. Interested in learning more?",
    collectLead: true,
    leadContext: "ecommerce_digital"
  },

  service_products: {
    message: "Service-based e-commerce is my specialty! Booking systems, service catalogs, and customer management - I've got you covered. Let's talk!",
    collectLead: true,
    leadContext: "ecommerce_services"
  },

  mixed_products: {
    message: "A comprehensive e-commerce solution! I love complex projects that showcase different product types. This sounds like an exciting challenge!",
    collectLead: true,
    leadContext: "ecommerce_mixed"
  },

  modern_design: {
    message: "I specialize in modern, conversion-focused designs that look amazing and perform even better. Let's give your site the makeover it deserves!",
    collectLead: true,
    leadContext: "redesign_modern"
  },

  performance_focus: {
    message: "Performance optimization is crucial! I can make your site lightning-fast, improving user experience and search rankings. Ready to accelerate?",
    collectLead: true,
    leadContext: "redesign_performance"
  },

  mobile_focus: {
    message: "Mobile-first design is essential today! I'll make sure your site looks perfect on all devices and converts mobile visitors into customers.",
    collectLead: true,
    leadContext: "redesign_mobile"
  },

  conversion_focus: {
    message: "Conversion optimization is my superpower! I've helped clients increase their conversion rates by 150%+. Let's boost your results!",
    collectLead: true,
  ...
  portfolio_details: {
    message: "Personal portfolios are a great way to showcase your work! I can create something that really makes you stand out. What's your main goal?",
    options: [
      { text: "Show my work professionally", next: "portfolio_professional", value: "professional" },
  ...
  blog_details: {
    message: "Blogs are powerful for building authority and audience! What type of content will you be sharing?",
    options: [
  ...
  portfolio_professional: {
    message: "Perfect! I'll create a portfolio that showcases your work in the most professional way possible. Let's discuss your vision!",
    collectLead: true,
    leadContext: "portfolio_professional"
  },

  portfolio_business: {
    message: "Great strategy! A well-designed portfolio can significantly increase your opportunities. I'd love to help you create something that converts!",
    collectLead: true,
    leadContext: "portfolio_business"
  },

  blog_business: {
    message: "Excellent choice! Business blogs are fantastic for establishing thought leadership. Let's create something that positions you as an expert!",
    collectLead: true,
    leadContext: "blog_business"
  },

  maintenance_details: {
    message: "Smart thinking! Regular maintenance keeps your site secure and performing well. I offer comprehensive maintenance packages. Let's discuss your needs!",
    collectLead: true,
    leadContext: "maintenance_support"
  },

  portfolio_showcase: {
    message: "I'd love to show you my work! You can check out my portfolio page to see my recent projects. Would you like me to open it for you?",
    options: [
  ...
  work_together: {
    message: "That's wonderful! I'd love to work with you. Let me get your contact details so we can discuss your project in detail.",
    collectLead: true,
...
This lead showed high engagement and is ready to discuss their project!
      ...
      formData.append('_autoresponse', 'Thanks for your interest! Chandrakant will get back to you within 24 hours.');
      ...
      addMessage(`Thank you, ${leadData.name}! 🎉 I'll personally reach out within 24 hours to discuss your project. In the meantime, feel free to explore my portfolio or check out my services page!`, 'bot', [
      ...
      addMessage("Oops! Something went wrong. Please try contacting me directly at nagpure.cr@gmail.com or use the contact form on my website.", 'bot');
    }
  ...
  const handleSpecialActions = (option) => {
    switch (option.value) {
      ...
      case 'restart':
        ...
        setIsTyping(false);
        setTimeout(() => addMessage(chatFlow.welcome.message, 'bot', chatFlow.welcome.options), 500);
        break;
    }
  };
