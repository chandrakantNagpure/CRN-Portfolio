...
const servicesData = [
  {
    ...
    description:
      'Custom React applications with state management, routing, and optimized performance.',
    features: [
  ...
  },
  {
    ...
    description:
      'Professional WordPress websites with custom themes, plugins, and SEO optimization.',
    features: [
            ...
            <div className="flex bg-white/20 backdrop-blur-md rounded-full p-2 border border-white/30">
              <button
                ...
                className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                  !showPackages ? 'text-white shadow-lg' : 'text-gray-600 hover:text-gray-800'
                }`}
                style={{
                ...
                <div className="text-center">
                  <motion.button
                    className={`w-full py-3 px-6 rounded-full font-semibold transition-all duration-300 ${
                      pkg.popular ? 'text-white shadow-lg' : 'border-2'
                    }`}
                    style={{
                  ...
                  <p className="text-xs mt-2 opacity-60">Timeline: {pkg.duration}</p>
                </div>
              </motion.div>
            ))}
          </div>
